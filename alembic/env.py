...
from app.models.task import ScheduledMessageTask, RuleMessageTask, AutoReplyRule, TaskExecutionLog
...
def to_sync_dsn(dsn: str) -> str:
    """Convert async DSN to sync DSN if needed, as Alembic migrations run synchronously."""
...
def get_url():
    ...
    return to_sync_dsn(settings.mysql_dsn)
